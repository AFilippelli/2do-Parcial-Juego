...
def mostrar_puntajes(puntaje, PANTALLA):

    fuente = pygame.font.SysFont('Impact', 30)
    pantalla = pygame.display.set_mode(PANTALLA)
    clock = pygame.time.Clock()
    pygame.display.set_caption('Dark Conquer')

    fondo = pygame.image.load('imagenes/fondo leaderbord/imagen_fondo_scores.webp')
    ...
    while correr:
        ...
        texto_letras = fuente.render(f'{letra_1 or "_"} {letra_2 or "_"} {letra_3 or "_"}', True, ('black'))
